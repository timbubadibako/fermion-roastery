...
export default function CartPage() {
  const { items: allItems, updateQuantity, removeItem, getTotal, clearCart } = useCartStore();
                      ...
                      <div className="flex-1 flex flex-col justify-between py-1">
                        ...
                        <div className="flex justify-between items-end mt-4">
                          <div className="flex items-center bg-stone-50 rounded-full px-2 py-1 border border-black/5">
                            ...
                            <button onClick={() => updateQuantity(item.lineItemId, item.quantity + 1)} className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-white hover:shadow-sm transition-all"><Plus size={12} /></button>
                          </div>
