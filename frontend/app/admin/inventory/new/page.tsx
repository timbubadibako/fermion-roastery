          ...
          <div className="bg-white border border-black/5 rounded-sm p-10 space-y-10 shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-3">
                ...
                <Input required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value, slug: formData.slug ? formData.slug : slugify(e.target.value) })} placeholder="Nama produk atau lot kopi" className="h-14 bg-stone-50 border-black/5 font-bold rounded-sm px-6 focus-visible:ring-[#367F4D]" />
              </div>
              <div className="space-y-3">
