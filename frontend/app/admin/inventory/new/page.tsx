        ...
        <div className="space-y-10 text-left">
          <div className="bg-slate-900 text-white rounded-sm p-10 space-y-10 shadow-2xl border border-black">
            <div className="space-y-6">
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Harga Retail Master (IDR)</label>
                <div className="relative">
                  ...
                  <span className="absolute right-6 top-1/2 -translate-y-1/2 text-white/20 font-black tracking-tighter italic text-xs">FALLBACK</span>
                </div>
              </div>
              <div className="space-y-3">
