  ...
  return (
    <div className="space-y-16 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
          { label: "Total Revenue", val: `Rp ${(stats.revenue / 1000000).toFixed(2)}M`, icon: TrendingUp, color: "text-green-500", trend: "+12%" },
          { label: "Volume Sold", val: `${stats.volume.toFixed(1)} Kg`, icon: Coffee, color: "text-fermion-french-blue", trend: "+8%" },
          ...
          >
             <div className="flex justify-between items-start relative z-10">
                ...
                <div className="flex items-center gap-1 text-[9px] font-black text-slate-400 uppercase tracking-widest bg-slate-50 px-2.5 py-1 rounded-full">
                   {s.trend}
                </div>
             </div>
