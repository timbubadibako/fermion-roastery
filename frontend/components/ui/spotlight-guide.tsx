  ...
  "/": [
    {
      ...
      title: t.spotlight.headerSearch?.title || "1. SISTEM PENCARIAN & KATALOG",
      content: t.spotlight.headerSearch?.content || "Cari biji kopi berdasarkan varietal, origin, notes rasa, atau metode pasca-panen secara instan dengan katalog terindeks.",
      position: "bottom",
    },
    {
      id: "header-lang",
      selector: "#tour-lang-btn",
      title: t.spotlight.headerLang?.title || "2. SAKELAR DUAL-BAHASA",
      content: t.spotlight.headerLang?.content || "Platform ini mendukung penyesuaian bahasa penuh (Bahasa Indonesia & English) untuk pelanggan retail maupun partner internasional.",
      position: "bottom",
    },
    {
      id: "header-account",
      selector: "#tour-account-btn, #tour-account-btn-login",
      title: t.spotlight.headerAccount?.title || "3. PORTAL AKUN DUAL-ROLE",
      content: t.spotlight.headerAccount?.content || "Sistem otentikasi cerdas yang membedakan hak akses antara Pelanggan Retail, Partner Grosir B2B (Partner Hub), dan Portal Admin.",
      position: "bottom",
    },
    {
      id: "header-cart",
      selector: "#tour-cart-wrapper",
      title: t.spotlight.headerCart?.title || "4. KERANJANG REALTIME & BOBOT",
      content: t.spotlight.headerCart?.content || "Drawer keranjang interaktif yang mengkalkulasi varian gilingan, akumulasi berat pengiriman, dan estimasi ongkos kirim secara otomatis.",
      position: "bottom",
    },
    {
      id: "our-coffee-link",
      selector: "nav a[href='/our-coffee']",
      title: t.spotlight.ourCoffee?.title || "5. STOREFRONT SPECIALTY COFFEE",
      content: t.spotlight.ourCoffee?.content || "Koleksi kurasi biji kopi pilihan dengan profil sangrai yang dikalibrasi presisi untuk espresso maupun filter drip.",
      position: "bottom",
    },
    {
      id: "wholesale-link",
      selector: "nav a[href='/wholesale']",
      title: t.spotlight.wholesale?.title || "6. SISTEM KEMITRAAN B2B GROSIR",
      content: t.spotlight.wholesale?.content || "Portal khusus pemilik kafe. Dilengkapi kalkulator tier diskon otomatis berbasis volume bulanan dan pendaftaran digital contract.",
      position: "bottom",
    },
    {
      id: "subscription-link",
      selector: "nav a[href='/subscription']",
      title: t.spotlight.subscription?.title || "7. SIKLUS BERLANGGANAN",
      content: t.spotlight.subscription?.content || "Layanan berlangganan bulanan yang dikurasi langsung oleh Head Roaster. Kopi di-roasting fresh dan dikirim sesuai jadwal Anda.",
      position: "bottom",
    },
    {
      id: "journal-link",
      selector: "nav a[href='/journal']",
      title: t.spotlight.journalHero?.title || "8. ARSIP JURNAL & LAB SENSORY",
      content: t.spotlight.journalHero?.content || "Dokumentasi eksperimen roasting, laporan cupping score, origin story, dan catatan teknis dari laboratorium Fermion.",
      position: "bottom",
    }
  ],
  "/our-coffee": [
