  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center p-6 bg-slate-50">
      <div className="relative mb-8">
        <div className="absolute inset-0 bg-fermion-french-blue/20 blur-3xl rounded-full scale-150"></div>
        <div className="relative bg-white p-8 rounded-[3rem] shadow-xl border border-slate-100 animate-bounce">
          <Construction className="w-16 h-16 text-fermion-french-blue" />
        </div>
      ...
      <Link 
        href="/"
        className="bg-fermion-french-blue hover:bg-fermion-french-blue/90 text-white font-bold py-4 px-8 rounded-2xl shadow-lg shadow-fermion-french-blue/20 transition-all active:scale-95"
      >
        Back to Home
      </Link>
    </div>
